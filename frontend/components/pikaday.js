...
/*
 * IMPORTANT: I have modified the constructor to remove AMD/CommonJS support
 * since it was clashing with RequireJS. -Wes
 */
(function (root, factory) { root.Pikaday = factory(root.moment); }(this, function (moment)
{
    'use strict';
