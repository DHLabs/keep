...
DataView = (function(_super) {
  ...
  function DataView() {
    _ref3 = DataView.__super__.constructor.apply(this, arguments);
    return _ref3;
  }
  ...
  DataView.prototype.time_step = function(event) {
    ...
    this.step_current += 1;
    if (this.step_current <= this.data.models.length) {
  ...
  DataView.prototype.renderMap = function() {
    var center, constrainedMarker, controls, datum, geopoint, heatmapData, html, index, key, layers, marker, myIcon, value, _i, _j, _len, _len1, _ref4, _ref5, _ref6;
