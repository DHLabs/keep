...
DataView = (function(_super) {
  ...
  DataView.prototype.previous_control = null;
  ...
  DataView.prototype.renderMap = function() {
    var center, constrainedMarker, controls, datum, geopoint, heatmapData, html, index, key, layers, marker, myIcon, value, _i, _j, _len, _len1, _ref, _ref1, _ref2;
    ...
    alert(this.step_clicked);
    if (this.step_clicked) {
      this.previous_control.removeFrom(this.map);
    }
    this.previous_control = controls;
