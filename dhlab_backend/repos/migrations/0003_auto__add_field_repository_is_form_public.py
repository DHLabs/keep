...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Repository.is_form_public'
        db.add_column(u'repos_repository', 'is_form_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Repository.is_form_public'
        db.delete_column(u'repos_repository', 'is_form_public')
