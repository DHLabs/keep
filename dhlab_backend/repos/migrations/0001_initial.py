...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'repos_relationship', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('repo_parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='parent_relations', to=orm['repos.Repository'])),
            ('repo_child', self.gf('django.db.models.fields.related.ForeignKey')(related_name='child_relations', to=orm['repos.Repository'])),
        ))
        db.send_create_signal(u'repos', ['Relationship'])

        # Adding model 'Repository'
        db.create_table(u'repos_repository', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mongo_id', self.gf('django.db.models.fields.CharField')(max_length=24)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='repositories', null=True, to=orm['auth.User'])),
            ('org', self.gf('django.db.models.fields.related.ForeignKey')(related_name='repositories', null=True, to=orm['organizations.Organization'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'repos_relationship')
