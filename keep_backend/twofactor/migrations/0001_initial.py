...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'twofactor_userauthtoken', (
        ...
        db.send_create_signal(u'twofactor', ['UserAuthToken'])

        # Adding model 'UserAPIToken'
        db.create_table(u'twofactor_userapitoken', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'twofactor', ['UserAPIToken'])


    def backwards(self, orm):
        # Deleting model 'UserAuthToken'
        db.delete_table(u'twofactor_userauthtoken')

        # Deleting model 'UserAPIToken'
        db.delete_table(u'twofactor_userapitoken')
    ...
    models = {
        ...
        u'twofactor.userapitoken': {
            'Meta': {'object_name': 'UserAPIToken'},
