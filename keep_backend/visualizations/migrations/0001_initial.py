...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'visualizations_visualization', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('repo', self.gf('django.db.models.fields.related.ForeignKey')(related_name='visualizations', to=orm['repos.Repository'])),
            ('x_axis', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('y_axis', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'visualizations', ['Visualization'])


    def backwards(self, orm):
        # Deleting model 'Visualization'
        db.delete_table(u'visualizations_visualization')
