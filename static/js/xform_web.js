  ...
  $(function() {
    ...
    xFormView = (function(_super) {
      ...
      xFormView.prototype.initialize = function() {
        ...
        this.model.fetch({
          url: "/api/v1/forms/" + this.form_id + "/?user=admin&key=4f9941aced32d9ee1a4ec73fb3fe5bb9&format=json"
        });
        return this;
      };

      xFormView.prototype.isRelevant = function(child) {
      ...
      xFormView.prototype.loadForm = function() {
        ...
        relevance = (function() {
          ...
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            child = _ref[_i];
            _results.push(child.name + ":" + this.isRelevant(child));
          }
          return _results;
        }).call(this);
